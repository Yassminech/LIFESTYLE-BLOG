 ...
 * @access private (only logged in user)
 --------------------------------------- */
module.exports.profilePhototUploadCtrl = asyncHandler(async(req,res) =>{
  //1.validation
  if (!req.file){
...
/**---------------------------------------
 * @desc Dlete User Profile(Account)
 * @route /api/users/profile/:id
 * @method DELETE
 * @access private (only Aadmin or user himself)
 --------------------------------------- */
module.exports.deleteUserProfileCtrl = asyncHandler(async(req, res) =>{
  ...
  //4.Delete all posts image cloudinary that belong to this user
